...
- PRD/Story audit: ✅ traced — `<story ID(s)>` | ✅ traced — `<story ID>` updated first (new/extended scenario) | ⚠️ gap found — `<what, and fix>` | ❌ not run (reason) | — n/a, no logic/test change
