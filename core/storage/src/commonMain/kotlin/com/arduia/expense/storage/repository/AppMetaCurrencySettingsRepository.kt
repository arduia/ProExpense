...
class AppMetaCurrencySettingsRepository(
    ...
    override suspend fun getHomeCurrency(): Result<CurrencyCode?> = catchingResult {
        CurrencyCode(store.read().homeCurrencyCode)
    }

    override suspend fun setHomeCurrency(currency: CurrencyCode): Result<Unit> = catchingResult {
