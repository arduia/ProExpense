...
class DefaultCurrencyRepositoryTest {
    ...
    @Test
    fun getSettings_fallsBackToDefaultWhenUnset() = runTest {
    ...
    @Test
    fun setThenGet_returnsStoredHomeCurrency() = runTest {
    ...
    @Test
    fun getSettings_propagatesError() = runTest {
        val repo = DefaultCurrencyRepository(
