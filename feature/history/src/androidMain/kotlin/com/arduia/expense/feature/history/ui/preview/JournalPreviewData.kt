        ...
        rows =
            listOf(
                ...
                ProTransactionRowModel(
                    ...
                    "Transport · 09:15 AM",
                    "$3.50",
                    detailDateTimeLabel = "Today · 09:15 AM",
                ),
                ProTransactionRowModel(
                    "t3",
                    "coffee",
                    "Oat latte",
                    "Coffee runs · 08:40 AM",
                    "$5",
                    detailDateTimeLabel = "Today · 08:40 AM",
                ),
            ),
    )

private val journalYesterday =
    JournalDayUi(
        id = "2026-05-24",
        ...
        rows =
            listOf(
                ProTransactionRowModel(
                    ...
                    "Transport · 07:45 AM",
                    "$8",
                    detailDateTimeLabel = "Mon · May 23 · 07:45 AM",
                ),
            ),
    )
...
val previewJournalEmpty =
    JournalListUiState(
        days = emptyList(),
    )

val previewJournalLoading =
    JournalListUiState(
        days = emptyList(),
        isLoading = true,
    )

val previewJournalDetail =
...
val previewJournalQuickNote =
    JournalQuickNoteUiState(
