...
class ExportDataUseCaseTest {
    @Test
    fun invoke_delegatesToRepositoryWithFormat() =
        runTest {
...
class PreviewImportUseCaseTest {
    @Test
    fun invoke_delegatesToRepositoryWithContentAndFormat() =
        runTest {
            val record =
                FinanceRecord(
                    id = RecordId("r1"),
...
class ClearSelectedDataUseCaseTest {
    @Test
    fun invoke_clearsAllWhenEverythingSelected_ignoringOtherIds() =
        runTest {
    ...
    @Test
    fun invoke_clearsOnlySelectedCategories() =
        runTest {
            val repo = FakeClearDataRepository()
            val useCase = ClearSelectedDataUseCase(repo)
    ...
    @Test
    fun invoke_shortCircuitsOnFirstError() =
        runTest {
    ...
    @Test
    fun invoke_succeedsWithEmptySelection() =
        runTest {
            val repo = FakeClearDataRepository()
            val useCase = ClearSelectedDataUseCase(repo)
