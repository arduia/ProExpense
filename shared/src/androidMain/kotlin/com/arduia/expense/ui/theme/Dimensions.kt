...
data class ProExpenseDimensions(
    ...
    val homeFabRaise: Dp = 24.dp,
    val homeFabBottomOffset: Dp = 108.dp,
    val bottomNavHeight: Dp = 72.dp,
    val bottomNavIconBandHeight: Dp = 36.dp,
    val bottomNavLabelPaddingBottom: Dp = 10.dp,
    val bottomNavInsetH: Dp = 20.dp,
    val bottomNavBottomInset: Dp = 16.dp,
    val bottomNavShadowElevation: Dp = 12.dp,
