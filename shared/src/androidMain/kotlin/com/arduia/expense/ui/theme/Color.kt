...
// Dim, warm-neutral dark palette (à la Claude Code's dark theme) rather than Material's default
// near-black — every neutral below carries a slight warm tint instead of true gray/black.
val ProDarkColors = ProColors(
    ...
    onPrimaryWarm = Color(0xFF1C1B18),
    surface = Color(0xFF302F2B),
    onSurface = Color(0xFFECE8E1),
    onSurfaceVariant = Color(0xFFC9C4B9),
    onSurfaceMuted = Color(0xFF938E82),
    paper = Color(0xFF262624),
    paperAlt = Color(0xFF2A2A27),
    keypadKeyPressed = Color(0xFF3A3934),
    ...
    muted = Color(0xFF8A8579),
    muted2 = Color(0xFF6E6A5F),
    line = Color(0x19FFFFFF),
    lineSoft = Color(0x0FFFFFFF),
    lineStrong = Color(0xFF474640),
    scrim = Color(0xCC1C1B18),
    navInactive = Color(0xFF8E8E93),
    ...
    categoryBills = CategoryColorPair(Color(0xFF9E9E9E), Color(0xFF34332E)),
    ...
    categoryCoffee = CategoryColorPair(Color(0xFFBDBDBD), Color(0xFF34332E)),
    categoryPet = CategoryColorPair(Color(0xFFA5D6A7), Color(0xFF1B3D1F)),
    categoryOther = CategoryColorPair(Color(0xFFBDBDBD), Color(0xFF34332E)),
)
