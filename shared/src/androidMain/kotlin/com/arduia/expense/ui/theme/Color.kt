...
val ProDarkColors =
    ProColors(
        ...
        onPrimaryWarm = Color(0xFF121212),
        surface = Color(0xFF1E1E1E),
        onSurface = Color(0xFFE8E8E8),
        onSurfaceVariant = Color(0xFFBDBDBD),
        onSurfaceMuted = Color(0xFF9E9E9E),
        paper = Color(0xFF121212),
        paperAlt = Color(0xFF1A1A1A),
        keypadKeyPressed = Color(0xFF2C2C2C),
        ...
        muted2 = Color(0xFF616161),
        line = Color(0x19FFFFFF),
        lineSoft = Color(0x0FFFFFFF),
        lineStrong = Color(0xFF424242),
        ...
        categoryBills = CategoryColorPair(Color(0xFF9E9E9E), Color(0xFF2C2C2C)),
