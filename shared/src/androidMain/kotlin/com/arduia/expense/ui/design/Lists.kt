...
// ProRowKind and ProTransactionRowModel moved to commonMain (TransactionRowModel.kt) so the
// record -> row mapping can be shared with the iOS shell; same package, so call sites are unchanged.
