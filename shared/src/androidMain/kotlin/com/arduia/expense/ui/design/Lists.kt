...
// ProRowKind / ProTransactionRowModel moved to commonMain (TransactionRowModel.kt) so shared
// ViewModels can build rows for both the Compose and SwiftUI lists. Same package — no import churn.
