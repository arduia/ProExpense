...
- badge 38dp
- row pad 12dp
- list reorder affordance trailing

## Edge cases & error states

### Duplicate name

![Duplicate name](../screenshots/screens/edge-cat-dup.png)

Entering an existing name → “A category with this name already exists.” Name capped at 20 chars with counter; Add disabled until valid.
