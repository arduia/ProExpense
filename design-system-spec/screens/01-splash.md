...
|---|---|---|
| App logo | Centered product mark on paper | `Image / painterResource` |
| Wordmark | “Pro Expense” under the mark | `Text · displaySmall-ish` |

## Tokens applied

**Type**

- Wordmark — Instrument Serif 30sp / -0.015em (Hero greeting role)

**Color**

- background = paper #F5F5F5
- logo fill = primary #039BE5
- ink #212121

**Shape · spacing**

- Logo tile radius 14dp
- vertical stack gap 18dp
