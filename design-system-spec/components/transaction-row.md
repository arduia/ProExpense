...
The core list unit. Transactions are grouped under a day header carrying a serif date and a mono running total.

![Day group with transaction rows](../screenshots/txn-daygroup.png)

## Day group header
- `Row(SpaceBetween)`, padding `12 × 8 × 6` dp.
- Left: **Instrument Serif 18sp**, tracking `-0.01em` (e.g. "Today · May 25").
